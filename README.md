...
## Backend Programming
- [X] [MIT-6.0001](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-0001-introduction-to-computer-science-and-programming-in-python-fall-2016/lecture-videos/)
- [X] [CS Dojo:Python for absolute beginners](https://youtu.be/Z1Yd7upQsXY)
...
## Database
- [X] [freeCodeCamp: Database Design Full Course](https://medium.freecodecamp.org/database-design-full-course-43233664125b)
...
- [X] [Django Girls Tutorial](http://tutorial.djangogirls.org/en/index.html)
